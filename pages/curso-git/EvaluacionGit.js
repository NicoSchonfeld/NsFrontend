...
import preguntas from "../../components/evaluacionGIT/preguntas";
import Evaluacion from "../../components/Evaluacion";
import stylesEvaluacion from "../../styles/Evaluacion.module.css";

export default function EvaluacionGit() {
        ...
        <Evaluacion>
          <div className={stylesEvaluacion.containerPregunta}>
            <h3 className={stylesEvaluacion.title}>
              Obtuvíste {puntuacion} de {preguntas.length}
            </h3>
          </div>
          ...
          <div className={stylesEvaluacion.containerOpciones}>
            <h3 className={stylesEvaluacion.titleFinalExamen}>
              ...
              <br />
              Estás listo para pasar al curso de JavaScript.
            </h3>
            <button
  ...
  return (
    <Layout
      title="Evaluación GIT | NS FrontEnd"
      description="Evaluación del curso de GIT"
    >
      <section className={styles.sectionOne}>
        <article className={styles.wrapper}>
          <h3 className={styles.title}>Evaluación del curso GIT</h3>
          <p className={styles.parrafo}>
            Pon a prueba tus conocimientos en GIT para saber si vas por buen
            camino.
          </p>
          ...
          <h4 className={styles.subTitle}>En que consiste</h4>

          <p className={styles.parrafo}>
            La evaluación consta de 10 preguntas, las cuales para aprobar
            necesitas un minimo de 7 preguntas en verde. Al finalizar podras ver
            las respuestas en las que has fallado.
            <br />
            <br />
            No te preocupes si no logras aprobar, podes realizar el examen
