...
import preguntas from "../../components/evaluacionJS/preguntas";
import Evaluacion from "../../components/Evaluacion";
import stylesEvaluacion from "../../styles/Evaluacion.module.css";

export default function EvaluacionJS() {
    ...
    >
      <section className={styles.sectionOne}>
        <article className={styles.wrapper}>
          <h3 className={styles.title}>Evaluación del curso JavaScript</h3>
          <p className={styles.parrafo}>
            Pon a prueba tus conocimientos en JavaScript para saber si vas por
            buen camino.
          </p>
