...
import preguntas from "../../components/evaluacionCSS/preguntas";
import Evaluacion from "../../components/Evaluacion";
import stylesEvaluacion from "../../styles/Evaluacion.module.css";

export default function EvaluacionCSS() {
        ...
        <Evaluacion>
          ...
          <div className={stylesEvaluacion.containerOpciones}>
            <h3 className={stylesEvaluacion.titleFinalExamen}>
              Si tú puntuación es 7 o mayor
              <br />
              ¡Felicidades aprobaste! 🎊🎉
              <br />
              Estás listo para pasar al curso de Git & Github.
            </h3>
            <button
  ...
  return (
    <Layout
      title="Evaluación CSS | NS FrontEnd"
      description="Evaluación del curso de CSS"
    >
      <section className={styles.sectionOne}>
        <article className={styles.wrapper}>
          <h3 className={styles.title}>Evaluación del curso CSS</h3>
          <p className={styles.parrafo}>
            Pon a prueba tus conocimientos en CSS para saber si vas por buen
            camino.
          </p>
